...
export const shortWeekDaysList = ['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'];

export const LASER_PERCENT = 0.17;
export const TRANSFERRED_PERCENT = 150;
export const CREAM_PERCENT = 7.5;
